...
for f in HTSeq.GFF_Reader( gtf_file ):
   ...
   # see: https://stat.ethz.ch/pipermail/bioconductor/2012-June/046494.html


   f.attr['gene_id'] = f.iv.chrom + f.iv.strand + '_' + f.attr['gene_id'].replace( ":", "_" ) 
...
# Add line to remove 'chr-strand' info from gene name


#os.system("perl -i.bak -pe 's/chr\w{1,2}[+|-]_//g' " + out_file)


#os.system("rm " + out_file + ".bak")
